  ...
  if (isMobile) {
    return (
      <section className="py-8 px-2 relative z-10 bg-transparent min-h-[70vh] overflow-hidden">
        ...
        <div className="absolute bottom-20 left-8 w-12 h-12 bg-pink-400/10 rounded-full blur-md animate-pulse" style={{ animationDelay: '2s' }}></div>
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <motion.span 
                ...
                animate={{ boxShadow: ['0 0 20px rgba(251,191,36,0.3)', '0 0 30px rgba(251,191,36,0.5)', '0 0 20px rgba(251,191,36,0.3)'] }}
                  ...
                  <div className="absolute top-4 left-4 z-20">
                    ...
                    >
                      ...
                      <span className="text-white text-xs font-bold">
                        {slots !== null ? `${slots} spots` : 'Open Registration'}
                      </span>
                    </motion.div>
                  </div>
            ...
            <div>
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-blue-300 text-sm font-semibold">Date</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-blue-300 text-sm font-semibold">Venue</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-blue-300 text-sm font-semibold">Tickets</div>
