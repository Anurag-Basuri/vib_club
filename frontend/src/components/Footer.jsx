...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', icon: <FaLinkedin className="w-5 h-5" />, url: "https://www.linkedin.com/company/vibranta/" },
    { name: 'Instagram', icon: <FaInstagram className="w-5 h-5" />, url: "https://www.instagram.com/vibranta.in/" }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-blue-200 mb-8 max-w-md leading-relaxed">
              Empowering the next generation of innovators through hands-on projects, workshops, and community building.
            </p>
