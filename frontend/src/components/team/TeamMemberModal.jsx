	...
	return (
		<AnimatePresence>
			{isOpen && (
				...
				>
					<motion.div
						className="relative max-w-lg w-full rounded-2xl overflow-hidden bg-gradient-to-br from-[#0d1326] to-[#1a1f3a] border border-[#3a56c9] my-4 sm:my-8"
					...
					>
						...
						<div className="relative bg-gradient-to-br from-[#0a0f1f] to-[#1a244f] p-6 pb-16">
							<button
								onClick={onClose}
						...
						<div className="relative -mt-10 rounded-t-3xl bg-gradient-to-br from-[#0d1326] to-[#1a1f3a] p-6">
							{/* Navigation tabs */}
							<div className="flex justify-center gap-1 -mt-2 mb-6 overflow-x-auto pb-2">
								<button
