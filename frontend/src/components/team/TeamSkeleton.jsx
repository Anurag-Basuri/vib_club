                    ...
                    >
                        ...
                        <div className="flex flex-col items-center mb-8 px-4">
                            <motion.div 
                                ...
                                animate={{ 
                                    opacity: [0.4, 0.7, 0.4],
                                    borderColor: ['rgba(99, 102, 241, 0.2)', 'rgba(99, 102, 241, 0.4)', 'rgba(99, 102, 241, 0.2)']
                                }}
                                transition={{ duration: 2, repeat: Infinity, delay: sectionIndex * 0.3 }}
                            />
                            <motion.div 
                                ...
                                transition={{ duration: 3, repeat: Infinity, delay: sectionIndex * 0.4 }}
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 px-3">
                            {Array(6).fill(null).map((_, cardIndex) => (
                                <motion.div 
                                    ...
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ delay: (sectionIndex * 6 + cardIndex) * 0.05, duration: 0.4 }}
                                >
                                    <div className="w-full max-w-[300px]">
    ...
    >
        ...
        <div className="flex justify-center mb-5">
            <motion.div 
                ...
                animate={{ 
                    scale: [1, 1.05, 1],
                    borderColor: ['rgba(71, 85, 105, 0.2)', 'rgba(99, 102, 241, 0.3)', 'rgba(71, 85, 105, 0.2)']
                }}
        ...
        <div className="p-4 rounded-xl bg-white/5 mb-4 flex-1 space-y-3">
            ...
            <div className="flex items-center">
                <motion.div 
                    ...
                    animate={{ 
                        scale: [1, 1.1, 1],
                        backgroundColor: ['rgba(37, 99, 235, 0.2)', 'rgba(37, 99, 235, 0.4)', 'rgba(37, 99, 235, 0.2)']
                    }}
            ...
            <div className="flex items-center">
                <motion.div 
                    ...
                    animate={{ 
                        scale: [1, 1.1, 1],
                        backgroundColor: ['rgba(99, 102, 241, 0.2)', 'rgba(99, 102, 241, 0.4)', 'rgba(99, 102, 241, 0.2)']
                    }}
                    transition={{ duration: 2, repeat: Infinity, delay: index * 0.15 }}
                />
                <motion.div 
        ...
        <motion.div 
            ...
            animate={{ 
                opacity: [0.4, 0.6, 0.4],
                scale: [1, 1.02, 1],
                backgroundColor: ['rgba(99, 102, 241, 0.2)', 'rgba(99, 102, 241, 0.3)', 'rgba(99, 102, 241, 0.2)']
            }}
            transition={{ duration: 2, repeat: Infinity, delay: index * 0.1 }}
        />
