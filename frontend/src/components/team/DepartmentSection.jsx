                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 flex-1">
                            ...
                            <div className="flex-1 text-left">
                                <h3 className="text-xl sm:text-2xl font-bold text-white group-hover:text-blue-100 
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/0 via-indigo-600/0 to-indigo-600/10 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl pointer-events-none"></div>
                    </motion.button>
                </motion.div>
