            ...
            >
              ...
              {activeTab === 'ghostboard' && (
                <div className="h-full flex flex-col">
                  <div className="mb-6">
                    <h3 className="text-2xl font-bold text-white mb-2">Message Wall</h3>
                    <p className="text-purple-200">Share your experience anonymously</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 flex-grow overflow-auto max-h-[350px] pr-2">
                    {messages.length > 0 ? (
                      ...
                      <div className="col-span-full flex flex-col items-center justify-center h-full text-center py-12 text-purple-300">
                        ...
                        <p className="mt-2 text-sm opacity-80">Your anonymous echo will appear here</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {activeTab === 'arcade' && (
                <div className="h-full">
                  <div className="mb-6">
                    <h3 className="text-2xl font-bold text-white mb-2">Event Memory Game</h3>
                    <p className="text-purple-200">Flip cards to reveal fun facts about the event</p>
                  </div>
                      ...
                      >
                        <div className="relative w-full h-full perspective">
                          <motion.div
                            ...
                            animate={{ 
                              rotateY: flippedCards.includes(fact.id) ? 180 : 0 
                            }}
                          ...
                          >
                            {!flippedCards.includes(fact.id) ? (
                              ...
                              <div className="rotate-y-180 text-center">
                                ...
                                <p className="text-white text-sm">{fact.content}</p>
                              </div>
                            )}
                          </motion.div>
                        </div>
              ...
              {activeTab === 'one-liners' && (
                <div className="h-full flex flex-col items-center justify-center">
                  <div className="text-center max-w-2xl">
                    <h3 className="text-2xl font-bold text-white mb-2">Crowd Reactions</h3>
                    <p className="text-purple-200 mb-8">What attendees said in one sentence</p>
                      ...
                      {testimonials.map((_, idx) => (
                        <div 
                          ...
                          className={`w-2 h-2 rounded-full ${
                            idx === oneLiners ? 'bg-purple-400' : 'bg-white/30'
                          }`}
                        />
                      ))}
                    </div>
              ...
              {activeTab === 'energy' && (
                <div className="h-full">
                  <div className="mb-8 text-center">
                    <h3 className="text-2xl font-bold text-white mb-2">Event Energy Meter</h3>
                    <p className="text-purple-200">Vibes measured throughout the night</p>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
                    <div className="space-y-6">
                      {[
                        { label: "Crowd Hype", value: energyLevels.crowdHype, color: "from-cyan-400 to-blue-500" },
                        { label: "DJ Drops", value: energyLevels.djDrops, color: "from-purple-400 to-fuchsia-500" },
                        { label: "Lightshow", value: energyLevels.lightshow, color: "from-amber-400 to-orange-500" },
                        { label: "Food Wipeout", value: energyLevels.foodWipeout, color: "from-green-400 to-emerald-500" }
                      ].map((metric, index) => (
                        <div key={index}>
                        ...
                        <div className="w-48 h-48 rounded-full border-4 border-purple-500/30 flex items-center justify-center">
                          ...
                          <div className="text-center z-10">
                            ...
                            <div className="text-white text-xl font-bold">
                              {energyLevels.crowdHype > 85 ? "EPIC VIBES" : 
                               energyLevels.crowdHype > 70 ? "HIGH ENERGY" : "GOOD FLOW"}
                            </div>
                          </div>
                        </div>
                      </div>
