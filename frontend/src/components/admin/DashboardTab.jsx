        ...
        <div className="lg:col-span-2 bg-gray-800/50 rounded-xl p-6 border border-gray-700">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-2">
              <button className="px-3 py-1 text-sm bg-gray-700 rounded-lg">Week</button>
              <button className="px-3 py-1 text-sm bg-blue-600 rounded-lg">Month</button>
              <button className="px-3 py-1 text-sm bg-gray-700 rounded-lg">Year</button>
            </div>
          </div>
