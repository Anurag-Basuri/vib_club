...
import { CalendarDays, Plus, Search, Filter, ChevronDown } from 'lucide-react';
...
const EventsTab = ({ events, eventsLoading, eventsError, token, setDashboardError, getAllEvents }) => {
