...
import { useGetAllMembers, useBanMember, useUnbanMember, useRemoveMember } from '../../hooks/useMembers.js';
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-700 text-white hover:bg-gray-600 transition">
            <Filter className="h-5 w-5" />
            Filters
          </button>
          
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-500 transition">
            ...
            <tbody className="bg-gray-800 divide-y divide-gray-700">
              {filteredMembers.map((member) => (
                <tr key={member._id} className="hover:bg-gray-750/50 transition">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <StatusBadge 
                      status={member.isBanned ? 'banned' : member.isRemoved ? 'removed' : 'active'} 
                    />
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                    {member.isAdmin ? 'Admin' : member.isLeader ? 'Leader' : 'Member'}
                  </td>
