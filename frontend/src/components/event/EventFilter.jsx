    ...
    const getFilterStyles = (color, isActive) => {
        const colorConfig = {
            blue: {
                ...
                inactive: 'text-gray-400 border-gray-600/20 hover:text-blue-300 hover:border-blue-500/30 hover:bg-blue-500/5'
            },
            cyan: {
                active: 'bg-cyan-500/20 text-cyan-300 border-cyan-400/40 shadow-cyan-500/20',
                inactive: 'text-gray-400 border-gray-600/20 hover:text-cyan-300 hover:border-cyan-500/30 hover:bg-cyan-500/5'
            },
            red: {
                active: 'bg-red-500/20 text-red-300 border-red-400/40 shadow-red-500/20',
                inactive: 'text-gray-400 border-gray-600/20 hover:text-red-300 hover:border-red-500/30 hover:bg-red-500/5'
            },
            purple: {
                active: 'bg-purple-500/20 text-purple-300 border-purple-400/40 shadow-purple-500/20',
                inactive: 'text-gray-400 border-gray-600/20 hover:text-purple-300 hover:border-purple-500/30 hover:bg-purple-500/5'
            }
        };
