                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 text-sm">
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="text-xs text-blue-200 opacity-80">Date & Time</div>
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="text-xs text-cyan-200 opacity-80">Venue</div>
            ...
            >
                ...
                <div className="relative h-48 sm:h-56 overflow-hidden">
                    ...
                    <motion.div
                        ...
                        whileHover={{ scale: 1.05 }}
                    >
                        <div className="text-2xl font-black drop-shadow-lg">{eventDate.getDate()}</div>
