...
const ProfileDisplay = ({ member, onEditToggle, onResumeUpload, uploadResumeLoading }) => {
    ...
    return (
        <div className="space-y-8">
                ...
                <InfoCard icon={GraduationCap} title="Academic Information">
                    <div className="space-y-4">
                        ...
                        <InfoItem 
                            icon={Calendar} 
                            label="Year" 
                            value={member.year ? `${member.year}${member.year === 1 ? 'st' : member.year === 2 ? 'nd' : member.year === 3 ? 'rd' : 'th'} Year` : null}
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                <span className="text-xs text-red-600 dark:text-red-400 font-semibold bg-red-100 dark:bg-red-900/30 px-2 py-1 rounded">PDF</span>
            ...
            {(!member.email && !member.phone && !member.program && !member.year && 
              (!member.skills || member.skills.length === 0) && 
              (!member.socialLinks || member.socialLinks.length === 0) && 
              !member.bio && !member.resume?.url) && (
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">
                        Add your personal information, skills, and social links to make your profile more complete.
                    </p>
                    <button
