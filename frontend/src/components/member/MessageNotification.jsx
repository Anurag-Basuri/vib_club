...
const MessageNotification = ({ message, onClose }) => {
    ...
    const getStyles = () => {
        if (isSuccess) {
            ...
            return {
                container: 'bg-amber-50/95 dark:bg-amber-900/95 border-amber-200 dark:border-amber-700',
    ...
    return (
        <AnimatePresence>
            {message && (
                ...
                >
                    <div className={`p-4 rounded-xl shadow-lg border backdrop-blur-sm ${styles.container}`}>
                        ...
                        <motion.div
                            ...
                            className={`mt-3 h-1 rounded-full ${
                                isSuccess ? 'bg-green-300 dark:bg-green-600' :
                                isWarning ? 'bg-amber-300 dark:bg-amber-600' :
