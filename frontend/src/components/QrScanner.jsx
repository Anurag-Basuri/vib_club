...
import {
  QrCode, AlertCircle, CheckCircle, XCircle, RotateCcw, Mail,
  Phone, Calendar, CameraOff, Loader2
} from 'lucide-react';
...
const QRScanner = () => {
  ...
  const markAsUsed = async () => {
    ...
    try {
      const { data } = await apiClient.patch(`/api/tickets/check/${ticket.ticketId}/status`, { isUsed: true });
      setTicket(data.data);
          ...
          <div className="p-6">
            ...
            {cameraError ? (
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <button onClick={resetScanner} className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl">
                  Retry
                </button>
              </div>
            ) : scanning ? (
