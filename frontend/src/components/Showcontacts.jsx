                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                    ...
                    <div className="w-full md:w-auto flex flex-col sm:flex-row gap-2 items-stretch md:items-center">
                        ...
                        <div className="flex gap-2 w-full md:ml-4">
                            ...
                            >
                                <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-.293.707L15 12.414V18a1 1 0 01-1 1H10a1 1 0 01-1-1v-5.586L3.293 6.707A1 1 0 013 6V4z" />
                                </svg>
                            </button>
                        </div>
                    </div>
                                                    ...
                                                    <div className="flex items-start justify-between gap-3">
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <div className="flex items-center mt-1 text-sm flex-wrap gap-2">
                                                                ...
                                                                <span className="mx-1 text-gray-600 hidden sm:inline">•</span>
                                                        ...
                                                        <div className="flex items-center space-x-3">
                                                            <div className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(contact.status)}`}>
                                                                {contact.status}
                                                            </div>
                                                        ...
                                                        loadingContact ? (
                                                            ...
                                                            <div className="mt-4 pt-4 border-t border-gray-700">
                                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                                    <div>
                                                                        <h4 className="text-gray-400 text-sm font-medium mb-1 flex items-center">Name</h4>
                                                                        <p className="text-gray-300 text-sm">{selectedContact.name}</p>
                                                                    </div>
                                                                    <div>
                                                                        <h4 className="text-gray-400 text-sm font-medium mb-1 flex items-center">Email</h4>
                                                                        <p className="text-gray-300 text-sm">{selectedContact.email}</p>
                                                                    </div>
                                                                    <div>
                                                                        <h4 className="text-gray-400 text-sm font-medium mb-1 flex items-center">Phone</h4>
                                                                        <p className="text-gray-300 text-sm">{selectedContact.phone}</p>
                                                                    </div>
                                                                    <div>
                                                                        <h4 className="text-gray-400 text-sm font-medium mb-1 flex items-center">Subject</h4>
                                                                        <p className="text-gray-300 text-sm">{selectedContact.subject}</p>
                                                                    </div>
                                                                    <div className="sm:col-span-2">
                                                                        <h4 className="text-gray-400 text-sm font-medium mb-1 flex items-center">Message</h4>
                                                                        <p className="text-gray-300 text-sm bg-gray-900/30 rounded-lg p-3 whitespace-pre-wrap">{selectedContact.message}</p>
                                                                    </div>
                                                                    <div>
                                                                        <h4 className="text-gray-400 text-sm font-medium mb-1 flex items-center">Status</h4>
                                                                        <p className="text-gray-300 text-sm">{selectedContact.status}</p>
                                                                    </div>
                                                                    <div>
                                                                        <h4 className="text-gray-400 text-sm font-medium mb-1 flex items-center">Created At</h4>
                                                                ...
                                                                <div className="mt-4 flex flex-wrap gap-2">
                                                                    ...
                                                                    {errorResolve && <div className="text-red-400 mt-2 text-sm w-full">{errorResolve}</div>}
                                                                </div>
                                                            </div>
                                                        ) : (
                                                            <div className="mt-4 pt-4 border-t border-gray-700 text-center text-gray-400">Failed to load contact details</div>
                                                        )
                                                    )}
                                                </div>

                                                <div className="px-4 py-3 bg-gray-800/70 border-t border-gray-700 flex justify-between items-center text-sm">
                                                    <div className="text-xs text-gray-500 font-mono truncate">ID: {contact._id}</div>
