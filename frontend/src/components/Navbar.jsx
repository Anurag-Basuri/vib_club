			...
			>
				<div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between h-full">
					...
					<div className="flex items-center gap-3 sm:gap-4 flex-shrink-0 relative select-none">
						...
						{/* Logo with dark glassy background and subtle floating animation */}
						<div
							className="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center shadow-xl icon-float overflow-hidden border border-cyan-700/30"
							style={{
