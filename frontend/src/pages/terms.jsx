...
// 						(“Terms”) constitute a binding agreement by and between <b>SUBHAM RAJ</b>,
...
// 					By using our website and availing the Services, you fully agree to these Terms &
// 					Conditions. For any queries, contact us at{' '}
// 					<a
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-black via-blue-950 to-black text-white px-4 py-16 flex justify-center items-start">
            <div className="w-full max-w-4xl bg-blue-900/30 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-blue-500/40">
                ...
                <div className="text-blue-100 text-base leading-relaxed space-y-8">
                    <p>
                        These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between <b>ANURAG BASURI</b>, (“Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).
                    </p>
                    <ul className="list-disc pl-6 space-y-4">
                        <li>
                        ...
                        <li>
                            ...
                            <ul className="list-disc pl-6 mt-2 space-y-2">
                                ...
                                <li>
                                    All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Baharagora, JHARKHAND
                                </li>
                                <li>
