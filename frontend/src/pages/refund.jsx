      ...
      <div className="max-w-3xl w-full bg-blue-950/80 backdrop-blur-md rounded-3xl p-10 shadow-2xl border border-blue-500/40">
        ...
        <div className="text-blue-100 text-base leading-relaxed space-y-8">
          <p>
            ...
            Subham Raj believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
          </p>
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>
              ...
              Subham Raj does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
            </li>
            <li>
            ...
            <li>
              ...
              In case of any refunds approved by Subham Raj, it’ll take <b>3–5 days</b> for the refund to be processed to the end customer.
            </li>
          </ul>
        </div>
        ...
        <p className="mt-8 text-sm text-center text-blue-300 italic">
          For any queries or refund requests, please email us at <a href="mailto:vibranta.helpdesk@gmail.com" className="underline text-blue-300">vibranta.helpdesk@gmail.com</a>.
        </p>
      </div>
    </div>
  );
