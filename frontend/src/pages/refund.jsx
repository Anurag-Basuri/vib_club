...
// 						<br />
// 						Subham Raj believes in helping its customers as far as possible, and has
...
// 						</li>
// 						<li>
// 							<span className="font-semibold text-blue-300">Perishable Items:</span>
// 							<br />
// 							Subham Raj does not accept cancellation requests for perishable items
...
// 							This should be reported within <b>7 days</b> of receipt of the products.
...
// 							customer service within <b>7 days</b> of receiving the product. The
...
// 							</span>
// 							<br />
// 							In case of any refunds approved by Subham Raj, it’ll take{' '}
// 							<b>3–5 days</b> for the refund to be processed to the end customer.
// 						</li>
// 					</ul>
// 				</div>
...
// 					For any queries or refund requests, please email us at{' '}
// 					<a
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-black via-blue-950 to-black text-white px-4 py-12 flex flex-col items-center justify-center">
            <div className="max-w-3xl w-full bg-blue-950/80 backdrop-blur-md rounded-3xl p-10 shadow-2xl border border-blue-500/40">
                ...
                <div className="text-blue-100 text-base leading-relaxed space-y-8">
                    <p>
                        <span className="font-semibold text-blue-300">Legal Name: ANURAG BASURI</span>
                        <br />
                        ANURAG BASURI believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
                    </p>
                    <ul className="list-disc pl-6 space-y-4">
                        <li>
                        ...
                        <li>
                            ANURAG BASURI does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
                        </li>
                        <li>
                            In case of receipt of damaged or defective items please report the same to our Customer Service team. The request will, however, be entertained once the merchant has checked and determined the same at his own end. This should be reported within <b>7 days</b> of receipt of the products. In case you feel that the product received is not as shown on the site or as per your expectations, you must bring it to the notice of our customer service within <b>7 days</b> of receiving the product. The Customer Service Team after looking into your complaint will take an appropriate decision.
                        </li>
                        <li>
                            In case of complaints regarding products that come with a warranty from manufacturers, please refer the issue to them. In case of any Refunds approved by the ANURAG BASURI, it’ll take <b>3-5 days</b> for the refund to be processed to the end customer.
                        </li>
                    </ul>
                </div>
                <div className="mt-10 flex justify-center">
