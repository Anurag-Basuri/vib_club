            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                {!loading && events && events.length > 0 && (
                    ...
                    >
                        ...
                        >
                            <motion.div
                                className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-emerald-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                            />
                            <motion.div
                            ...
                            <motion.div
                                className="absolute inset-0 border border-green-400/20 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            />
                        </motion.div>
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                animate={ongoingCount > 0 ? { 
                                    scale: [1, 1.1, 1],
                                    textShadow: ["0 0 0px #ff0000", "0 0 10px #ff0000", "0 0 0px #ff0000"]
                                } : {}}
                        ...
                        >
                            <motion.div
                                className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-pink-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                            />
                            ...
                            <motion.div
                                className="absolute inset-0 border border-purple-400/20 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            />
                        </motion.div>
                    </motion.div>
                )}
