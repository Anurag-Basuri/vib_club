        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center gap-8 z-10 px-4">
            ...
            <div className="p-6 md:p-8">
                ...
                <form className="animate-fade-in">
                    ...
                    <a href="#" className="text-[#8e2de2] font-medium hover:underline transition-all">Forgot Password?</a>
                    </div>
                </form>
                )}
                ...
                <form className="animate-fade-in">
                    ...
                    <p className="mt-1 text-xs text-white/60">Hold Ctrl/Cmd to select multiple</p>
                    </div>
                    <div className="mb-6 relative">
