...
const InputField = ({ 
  ...
  <div className={`mb-4 relative ${className}`}>
    ...
    />
    {error && (
      <p className="mt-1 text-sm text-red-400 pl-2">{error}</p>
    )}
  </div>
);
...
const LoginForm = ({
  ...
  >
    ...
    <div className="mb-4 relative">
      ...
      {errors.password && (
        <p className="mt-1 text-sm text-red-400 pl-2">{errors.password}</p>
      )}
    </div>
...
const RegisterForm = ({
  ...
  >
    ...
    <div className="mb-4">
                  ...
                  handleRegisterChange({
                    target: {
                      ...
                      value: checked 
                        ...
                        : registerData.domains.filter(d => d !== domain.value)
                    }
                  });
                }}
      ...
      {errors.domains && (
        <p className="mt-1 text-sm text-red-400">{errors.domains}</p>
      )}
