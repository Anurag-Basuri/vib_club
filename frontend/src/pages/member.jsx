...
import { 
  User, Mail, BookOpen, Edit, Globe, Linkedin, Github, 
  Lock, Upload, Check, Eye, EyeOff, X, Copy 
} from 'lucide-react';
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-900/20 to-indigo-900/20 rounded-xl border border-white/10 group-hover:border-blue-400 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-sm text-gray-300 truncate max-w-[150px]">{user.social.linkedin}</p>
                      )}
                    </div>
                  </div>
                  ...
                  {!isEditing && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={() => copyToClipboard(user.social.linkedin, 'linkedin')}
                      className="text-gray-400 hover:text-white"
                    >
                      {copied.linkedin ? <Check size={18} /> : <Copy size={18} />}
                    </motion.button>
                  )}
                </div>
              </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-900/20 to-indigo-900/20 rounded-xl border border-white/10 group-hover:border-blue-400 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-sm text-gray-300 truncate max-w-[150px]">{user.social.github}</p>
                      )}
                    </div>
                  </div>
                  ...
                  {!isEditing && (
                    <motion.button
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.9 }}
                      onClick={() => copyToClipboard(user.social.github, 'github')}
                      className="text-gray-400 hover:text-white"
                    >
                      {copied.github ? <Check size={18} /> : <Copy size={18} />}
                    </motion.button>
                  )}
                </div>
              </div>
            ...
            <AnimatePresence>
              {showPasswordForm && (
                ...
                >
                  <div className="space-y-4">
                    <div>
                      <label className="text-blue-300 text-sm mb-1 block">Current Password</label>
                    ...
                    <div>
                      <label className="text-blue-300 text-sm mb-1 block">New Password</label>
                      <div className="relative">
                        <input
                    ...
                    <div>
                      <label className="text-blue-300 text-sm mb-1 block">Confirm New Password</label>
                      <div className="relative">
                        <input
